export default function ListView({isMobile}) {
    return (
        <div className="flex flex-row justify-center flex-wrap gap-x-[0rem]">
            ...
            <div className={`relative 
                ...
                ${ isMobile ? 'mt-1 mb-1 ml-1 w-[10rem]' : " w-[16rem] ml-10 mt-1 mr-[-1.8rem] mb-10"}

                max-w-xs flex flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md hover-zoom`}>
