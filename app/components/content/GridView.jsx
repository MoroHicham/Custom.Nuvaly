    ...
    return (
        <div className="flex flex-row flex-wrap ">
            ...
            <div className={`relative 
                ...
                ${ isMobile ? 'mt-1 mb-1 basis-1/2' : " w-[16rem] ml-10 mt-1 mr-[-1.8rem] mb-10"}

                max-w-xs flex flex-col overflow-hidden rounded-sm border border-gray-100 bg-white shadow-md hover-zoom`}>
