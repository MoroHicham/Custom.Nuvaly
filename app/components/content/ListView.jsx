    ...
    return (
        <>
            ...
            <div className="container justify-start flex-wrap">
                ...
                <div className="w-full pb-4 flex flex-row  overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md hover-zoom">

                    <a className="relative flex-row mx-3 mt-3 flex h-50 overflow-hidden rounded-xl" href="#">
                        <img className="w-[13rem] h-[13rem]" src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8c25lYWtlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" alt="product image" />
                    ...
                    <div className="flex flex-col basis-1/2 items-end justify-between">

                        <div className="mt-2 mb-5 flex flex-col items-center justify-between">
                            <p><span className="text-[1.2rem] font-bold text-slate-900">449 Dhs</span></p>
                            <p><span className="text-[1rem] text-slate-900 line-through">699 Dhs</span><span className="bg-orange-200 text-yellow-600 ml-2">-{(((699 - 449) / 699) * 100).toFixed(2)}%</span></p>
                        </div>
